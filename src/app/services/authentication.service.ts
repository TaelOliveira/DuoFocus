  ...
  registerUser(value){
    ...
    .then((newUserCredential: firebase.auth.UserCredential) => {
      firebase
        ...
        .set({'email': value.email, 'student': 'true', 'photoURL': 'https://firebasestorage.googleapis.com/v0/b/duofocus-c5eca.appspot.com/o/avatar.png?alt=media&token=f232e127-8584-4638-ab2c-489a8f6343c5'});
    })
    .catch((error) => {
